...
extern inline int EEex_read_byte(void*, int8_t);
extern inline int EEex_read_word(void*, int16_t);
extern inline int EEex_read_dword(void*, int32_t);
extern inline int EEex_read_qword(void*, int64_t);
